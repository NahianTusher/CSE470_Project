...
if(isset($_POST['fdestination']) && isset($_POST['fdeparture']) && isset($_POST['fdate'])){
	...
	$sql = "SELECT passenger_limit,date,flight_id,departure,destination,departure_time FROM flight_details WHERE destination ='$i' AND date = '$t' AND departure ='$g'";  
